                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= webDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.store_front_url_abs = "//codecloud.cdn.speedyrails.net/sites/5af46c3b6e6f644d65050000/image/png/1518554684072/bonniedoonlogo.png";
                            }
                            ...
                            if (value.event_image_url_abs != null && value.event_image_url_abs != undefined && _.includes(value.event_image_url_abs, 'missing')) {
                                value.event_image_url_abs = vm.property.default_logo_url;
                            }
