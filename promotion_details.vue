			...
			<div class="row">
				<div class="col-sm-4 promo_logo_container hidden_phone">
					...
					<div class="text-center">
						...
						<h3 v-if="currentPromo.store.website" class="store_dets_title"> <a :href="'//'+currentPromo.store.website" target="_blank"> {{$t("stores_page.store_website")}}</a></h3>
				...
				<div class="col-sm-8 promo_image_container text-left">
					...
					<div class="col-sm-12 no_padding">
						<img v-if="!_.includes(currentPromo.image_url, 'missing')" v-lazy="currentPromo.image_url" class="image" :alt="currentPromo.name + ' from ' + currentPromo.store.name "/>
