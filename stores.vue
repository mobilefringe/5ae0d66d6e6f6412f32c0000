			...
			<div class="row bold">
				<div class="col-sm-6 col-md-4">
					<div class="store_search" >
						...
						<img src="//codecloud.cdn.speedyrails.net/sites/5ae0d66d6e6f6412f32c0000/image/png/1517497861636/search_icon_2x.png" class="pull-right" id="store_search_img" alt="">
					</div>
				</div>
				<div class="col-sm-6 col-md-4">
					<div class="store_search" >
                ...
                allStores() {
                    ...
                    stores.map(store => {
                       if (_.includes(store.store_front_url_abs, 'missing')) {
                            store.store_front_url_abs = vm.property.default_logo_url;
                        }
                    });
