			...
			<div class="row">
				<div class="col-sm-12 promo_image_container text-left">
					...
					<div class="row">
						...
						<social-sharing :url="shareURL(currentEvent.slug)" :title="currentEvent.title" :description="currentEvent.description" :quote="currentEvent.description_short" twitter-user="BonnieDoonSC" :media="currentEvent.image_url" inline-template >
