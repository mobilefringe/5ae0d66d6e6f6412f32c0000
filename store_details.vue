		...
		<div class="site_container">
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					<div class="col-sm-12 no_padding light_border">
					...
					<div class="text-center">
						...
						<ul class="store_hours_list">
							<li v-if="storeHours" v-for="hour in storeHours" class="col-xs-12">
								...
								<span v-else class="text-left">{{hour.open_time | moment("h:mmA", timezone)}} - {{hour.close_time | moment("h:mmA", timezone)}}</span>
							</li>
						</ul>
					</div>
				</div>
